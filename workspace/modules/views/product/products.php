                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="first">
                                    ...
                                    <td><?php echo empty($product->ishot) ? '不热卖' : '热卖'; ?></td>
                                    <td><?php echo empty($product->issale) ? '不促销' : '促销';?></td>
                                    <td><?php echo $product->saleprice;?></td>
                                    <td><?php echo empty($product->ison) ? '下架' : '上架';?></td>
                                    <td><?php echo empty($product->istui) ? '不推荐' : '推荐';?></td>
